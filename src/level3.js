...
var Level3 = {
  ...
  update: function(){
    ...
    if (squirrel2 != null){
      ...
      squirrelProgress2.drawCircle(.1*screen1Width + .8*screen1Width*squirrel2X/level3Length, .05*screen1Height, 20);
      squirrelProgress2.endFill();
      squirrelProgress2.scale.setTo(1/zoom);

      if (squirrel2X > level3Length){
        squirrelProgress.destroy();
        squirrelProgress2.destroy();
        game.state.start('levelFailed');
        game2.state.start('levelFailed');
...
var Level3_2 = {
  ...
  create: function(){
    ...
    terrain2 = new Terrain(game2, 3, 3, 2, 'Snake');
